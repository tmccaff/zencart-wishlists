...
?>
		...
		<ul>
		<li><?php echo TABLE_HEADING_ITEMS . LABEL_DELIMITER . $records->fields['items_count']; ?> 
		...
		<li><?php echo TABLE_HEADING_COMMENT . LABEL_DELIMITER . $records->fields['comment']; ?></li>
		<li><?php echo TABLE_HEADING_DEFAULT . LABEL_DELIMITER; ?>
		...
		<li><?php echo TABLE_HEADING_PUBLIC . LABEL_DELIMITER; ?>
